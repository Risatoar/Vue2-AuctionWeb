				           ...
				           <Tabs type="card">
				               <Tab-pane label="知识详情">
				               	<div style="text-align:center;">
				               		...
				               		<p style="padding:0 20px;font-size:16px;float:left;text-indent:25px;color:#657180;font-family:Text;line-height:2;text-align:left;" v-html="knowledgedetaillist.maintext">
				               		</p>
				               	</div>
				               </Tab-pane>
				           </Tabs>
